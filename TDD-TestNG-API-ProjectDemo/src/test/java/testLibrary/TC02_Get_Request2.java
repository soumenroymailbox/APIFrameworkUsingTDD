...
public class TC02_Get_Request2 extends BaseTest
{
	...
	void getBooksDetails()
	{
		...
		httpRequest = RestAssured.given().queryParam("ISBN","9781449325862"); 
		response = httpRequest.request(Method.GET, "/Book");
